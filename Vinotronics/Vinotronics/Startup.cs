...
namespace Vinotronics
{
    public class Demo
    {
        private OrderCall ordercall, CANordercall;
        private ItemCall itemCall, CANitemCall;
        ...
        public Demo()
        {
            ...
            APIClient fakeUSAClientXML = new APIClient(USA_Config_XML) { SimulationEnabled = true };
            APIClient fakeCANClientXML = new APIClient(CAN_Config_XML) { SimulationEnabled = true };
